...
GMAPKEY = 'AIzaSyDKuQR1Dd5Fb0sPJXDnIvwGpJ85yZJzW0k'
...
class locations:
    ...
    def GET(self):
        ...
        c, rdata['ctr'] = gcoder.geocode("175 5th Avenue NYC")#rdata['zip'])
        rdata['key'] = GMAPKEY
